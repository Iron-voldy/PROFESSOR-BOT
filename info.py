...
BOT_TOKEN = environ.get('BOT_TOKEN', '8064076565:AAE5BD4kUzb4goJhI2SWBgaXvU_BHkR_VhU')

# Subtitle API Configuration
SUBDL_API_KEY = environ.get('SUBDL_API_KEY', 'm0p951wAUtfeDVwBzSXk5DOMRpvqAhtR')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002886647880 -1002766947260').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002886647880')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://hasindu:20020224Ha@cluster0.pvs7qpx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&serverSelectionTimeoutMS=10000&socketTimeoutMS=10000&connectTimeoutMS=10000&maxPoolSize=10&minPoolSize=1")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
FILE_DB_URL = environ.get("FILE_DB_URL", DATABASE_URL)
FILE_DB_NAME = environ.get("FILE_DB_NAME", DATABASE_NAME)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Alternative MongoDB connection for DNS issues (using IP resolution)
DATABASE_URL_FALLBACK = environ.get('DATABASE_URL_FALLBACK', "mongodb+srv://hasindu:20020224Ha@cluster0.pvs7qpx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&serverSelectionTimeoutMS=5000&socketTimeoutMS=5000&connectTimeoutMS=5000&directConnection=false")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002822738923))
